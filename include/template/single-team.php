                                ...
                                <?php foreach ($team_skill_list as $single_skill): ?>
                                    <div class="it-progress-bar-item mb-10">
                                        ...
                                        <div class="it-progress-bar">
                                            <div class="progress">
                                                <div class="progress-bar wow slideInLeft" data-wow-delay=".1s" data-wow-duration="2s" role="progressbar" data-width="<?php echo esc_attr($single_skill['service_skill_value']); ?>%" aria-valuenow="<?php echo esc_attr($single_skill['service_skill_value']); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo esc_attr($single_skill['service_skill_value']); ?>%; visibility: visible; animation-duration: 2s; animation-delay: 0.1s; animation-name: slideInLeft;">
